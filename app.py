...
from model import (
    ...
    PHASE_COLORS, CAT_FEATURES, TEIL_OPTIONS, TEIL_COLS, AUXILIARY,
)
...
st.title("Proof of Concept mit synthetischen Daten")
st.caption("Kaskadierende Modellkette zur initialen PEP-Terminplanung · Bachelorarbeit")
st.divider()
...
with tab_manual:
    ...
    selected_teile = st.multiselect(
        "Schwerpunktumfänge — betroffene Bauteile",
